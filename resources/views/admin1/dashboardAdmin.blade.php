		...
		<body class="hold-transition sidebar-mini layout-fixed" >
			...
			<aside class="main-sidebar sidebar-dark-primary elevation-4">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					...
					<div class="info">
						<a href="#" class="d-block">Admin Connecté !!</a>
					</div>
					
				</div>
				<div class="info">
						<a href="admin1/create" class="text-white d-block">Region</a>
				</div>
				<div class="info">
						<a href="admin1/createTrajet" class="text-white d-block">Trajet</a>
				</div>
			...
			<div class="content-wrapper">
				...
				<div class="container-fluid">
					...
					<div class="col-lg-3 col-6">
						...
						<a href="admin1/utilisateur" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
						</div>
					</div>
					<!-- ./col -->
					<div class="col-lg-3 col-6">
